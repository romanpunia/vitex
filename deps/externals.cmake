...
if (VI_SQLITE)
	...
	if (SQLITE_LOCATION)
		target_include_directories(mavi PRIVATE ${SQLITE_LOCATION})
		find_package(SQLite3 CONFIG QUIET)
		if (NOT SQLite3_FOUND)
			find_library(SQLITE_LIBRARY "sqlite3")
			if (SQLITE_LIBRARY)
				set(SQLite3_LIBRARIES "${SQLITE_LIBRARY}")
				target_compile_definitions(mavi PRIVATE -DVI_SQLITE)
		...
		if (SQLite3_FOUND OR SQLite3_LIBRARIES)
			if (DEFINED SQLite3_LIBRARIES)
				...
				target_link_libraries(mavi PRIVATE ${SQLite3_LIBRARIES})
				message(STATUS "SQLite3 library found")
			else()
				target_link_libraries(mavi PRIVATE SQLite3::SQLite3)
