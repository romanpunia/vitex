...
if (VI_JIT)
    target_compile_definitions(vitex PUBLIC -DVI_JIT)
endif()
if (VI_SIMD)
    target_compile_definitions(vitex PUBLIC -DVI_SIMD)
    target_include_directories(vitex PRIVATE ${PROJECT_SOURCE_DIR}/deps/vectorclass)
endif()
if (VI_BACKTRACE)
    target_compile_definitions(vitex PUBLIC -DVI_BACKTRACE)
...
if (VI_FCTX)
    target_compile_definitions(vitex PUBLIC -DVI_FCTX)
