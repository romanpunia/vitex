...
if (ED_USE_BULLET3)
    ...
    if (MSVC)
        target_compile_options(edge PRIVATE $<$<COMPILE_LANGUAGE:CXX>:/wd4305>)
        target_compile_options(edge PRIVATE $<$<COMPILE_LANGUAGE:CXX>:/wd4244>)
        target_compile_options(edge PRIVATE $<$<COMPILE_LANGUAGE:CXX>:/wd4018>)
        target_compile_options(edge PRIVATE $<$<COMPILE_LANGUAGE:CXX>:/wd4267>)
    endif()
endif()
...
if (ED_USE_RMLUI)
	...
	target_compile_definitions(edge PRIVATE
            ...
            -DRMLUI_CUSTOM_CONFIGURATION_FILE="${PROJECT_SOURCE_DIR}/src/edge/engine/gui/config.hpp")
