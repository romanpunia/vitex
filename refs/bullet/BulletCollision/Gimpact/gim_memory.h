...
email: projectileman@yahoo.com
 ...
 This refs is free software; you can redistribute it and/or
 modify it under the terms of EITHER:
   (1) The GNU Lesser General Public License as published by the Free
       Software Foundation; either version 2.1 of the License, or (at
       your option) any later version. The text of the GNU Lesser
       General Public License is included with this refs in the
       file GIMPACT-LICENSE-LGPL.TXT.
   (2) The BSD-style license that is included with this refs in
       the file GIMPACT-LICENSE-BSD.TXT.
   (3) The zlib/libpng license that is included with this refs in
       the file GIMPACT-LICENSE-ZLIB.TXT.

 This refs is distributed in the hope that it will be useful,
...
inline void gim_simd_memcpy(void *dst, const void *src, size_t copysize)
{
	...
	/*
//'long long int' is incompatible with graphics studio 6...
    //copy words
