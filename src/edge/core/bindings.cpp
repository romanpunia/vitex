...
namespace Edge
{
	...
	#undef COMPARE
			...
			bool Registry::LoadArray(VMManager* Manager)
			{
				...
				Engine->RegisterObjectMethod("array<T>", "void insertAt(usize Index, const T&in Value)", asMETHODPR(Array, InsertAt, (size_t, void*), void), asCALL_THISCALL);
				Engine->RegisterObjectMethod("array<T>", "void insertAt(usize Index, const array<T>& Array)", asMETHODPR(Array, InsertAt, (size_t, const Array&), void), asCALL_THISCALL);
				...
				Engine->RegisterObjectMethod("array<T>", "void removeAt(usize Index)", asMETHOD(Array, RemoveAt), asCALL_THISCALL);
				Engine->RegisterObjectMethod("array<T>", "void removeLast()", asMETHOD(Array, RemoveLast), asCALL_THISCALL);
				Engine->RegisterObjectMethod("array<T>", "void removeRange(usize Start, usize Count)", asMETHOD(Array, RemoveRange), asCALL_THISCALL);
				...
				Engine->RegisterObjectMethod("array<T>", "void sortAsc(usize StartAt, usize Count)", asMETHODPR(Array, SortAsc, (size_t, size_t), void), asCALL_THISCALL);
				Engine->RegisterObjectMethod("array<T>", "void sortDesc()", asMETHODPR(Array, SortDesc, (), void), asCALL_THISCALL);
				Engine->RegisterObjectMethod("array<T>", "void sortDesc(usize StartAt, usize Count)", asMETHODPR(Array, SortDesc, (size_t, size_t), void), asCALL_THISCALL);
				...
				Engine->RegisterObjectMethod("array<T>", "usize findByRef(const T&in if_handle_then_const Value) const", asMETHODPR(Array, FindByRef, (void*) const, int), asCALL_THISCALL);
				Engine->RegisterObjectMethod("array<T>", "usize findByRef(usize StartAt, const T&in if_handle_then_const Value) const", asMETHODPR(Array, FindByRef, (size_t, void*) const, int), asCALL_THISCALL);
			...
			bool Registry::LoadMath(VMManager* Manager)
			{
				...
				Engine->RegisterGlobalFunction("float fpFromIEEE(uint)", asFUNCTIONPR(Math::FpFromIEEE, (uint32_t), float), asCALL_CDECL);
				Engine->RegisterGlobalFunction("uint fpToIEEE(float)", asFUNCTIONPR(Math::FpToIEEE, (float), uint32_t), asCALL_CDECL);
			...
			bool Registry::LoadString(VMManager* Manager)
			{
				...
				Engine->RegisterObjectMethod("string", "int findFirst(const string &in, usize = 0) const", asFUNCTION(String::FindFirst), asCALL_CDECL_OBJLAST);
				Engine->RegisterObjectMethod("string", "int findFirstOf(const string &in, usize = 0) const", asFUNCTION(String::FindFirstOf), asCALL_CDECL_OBJLAST);
				Engine->RegisterObjectMethod("string", "int findFirstNotOf(const string &in, usize = 0) const", asFUNCTION(String::FindFirstNotOf), asCALL_CDECL_OBJLAST);
				...
				Engine->RegisterGlobalFunction("int64 toInt(const string &in, usize = 10, usize &out = 0)", asFUNCTION(String::IntStore), asCALL_CDECL);
				Engine->RegisterGlobalFunction("uint64 toUInt(const string &in, usize = 10, usize &out = 0)", asFUNCTION(String::UIntStore), asCALL_CDECL);
				Engine->RegisterGlobalFunction("double toFloat(const string &in, usize &out = 0)", asFUNCTION(String::FloatStore), asCALL_CDECL);
			...
			bool Registry::LoadThread(VMManager* Manager)
			{
				...
				Engine->RegisterObjectMethod("thread", "string getId() const", asMETHODPR(Thread, GetId, () const, std::string), asCALL_THISCALL);

				Manager->BeginNamespace("this_thread");
				Engine->RegisterGlobalFunction("thread@+ getRoutine()", asFUNCTION(Thread::GetThread), asCALL_CDECL);
				Engine->RegisterGlobalFunction("uint64 getId()", asFUNCTION(Thread::GetThreadId), asCALL_CDECL);
