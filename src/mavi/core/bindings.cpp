...
#undef COMPARE
			...
			bool Registry::ImportVertices(VirtualMachine* VM)
			{
#ifdef VI_BINDINGS
				VI_ASSERT(VM != nullptr, "manager should be set");
				auto VVertex = VM->SetPod<Compute::Vertex>("vertex");
				...
				auto VSkinVertex = VM->SetPod<Compute::SkinVertex>("skin_vertex");
				...
				auto VShapeVertex = VM->SetPod<Compute::ShapeVertex>("shape_vertex");
				...
				auto VElementVertex = VM->SetPod<Compute::ElementVertex>("element_vertex");
			...
			bool Registry::ImportVectors(VirtualMachine* VM)
			{
				...
				auto VVector2 = VM->SetPod<Compute::Vector2>("vector2");
				...
				auto VVector3 = VM->SetPod<Compute::Vector3>("vector3");
				...
				auto VVector4 = VM->SetPod<Compute::Vector4>("vector4");
				...
				auto VMatrix4x4 = VM->SetPod<Compute::Matrix4x4>("matrix4x4");
				...
				auto VQuaternion = VM->SetPod<Compute::Vector4>("quaternion");
			...
			bool Registry::ImportShapes(VirtualMachine* VM)
			{
#ifdef VI_BINDINGS
				VI_ASSERT(VM != nullptr, "manager should be set");
				auto VRectangle = VM->SetPod<Compute::Rectangle>("rectangle");
				...
				auto VBounding = VM->SetPod<Compute::Bounding>("bounding");
				...
				auto VRay = VM->SetPod<Compute::Ray>("ray");
				...
				auto VFrustum8C = VM->SetPod<Compute::Frustum8C>("frustum_8c");
				...
				auto VFrustum6P = VM->SetPod<Compute::Frustum6P>("frustum_6p");
			...
			bool Registry::ImportKeyFrames(VirtualMachine* VM)
			{
#ifdef VI_BINDINGS
				VI_ASSERT(VM != nullptr, "manager should be set");
				auto VJoint = VM->SetStructTrivial<Compute::Joint>("joint");
				...
				auto VAnimatorKey = VM->SetPod<Compute::AnimatorKey>("animator_key");
				...
				auto VSkinAnimatorKey = VM->SetStructTrivial<Compute::SkinAnimatorKey>("skin_animator_key");
				...
				auto VSkinAnimatorClip = VM->SetStructTrivial<Compute::SkinAnimatorClip>("skin_animator_clip");
				...
				auto VKeyAnimatorClip = VM->SetStructTrivial<Compute::KeyAnimatorClip>("key_animator_clip");
				...
				auto VRandomVector2 = VM->SetPod<Compute::RandomVector2>("random_vector2");
				...
				auto VRandomVector3 = VM->SetPod<Compute::RandomVector3>("random_vector3");
				...
				auto VRandomVector4 = VM->SetPod<Compute::RandomVector4>("random_vector4");
				...
				auto VRandomFloat = VM->SetPod<Compute::RandomFloat>("random_float");
			...
			bool Registry::ImportGeometric(VirtualMachine* VM)
			{
				...
				auto VSpacing = VM->SetPod<Compute::Transform::Spacing>("transform_spacing");
				...
				auto VTransform = VM->SetClass<Compute::Transform>("transform", false);
				...
				auto VNode = VM->SetPod<Compute::Cosmos::Node>("cosmos_node");
			...
			bool Registry::ImportPhysics(VirtualMachine* VM)
			{
				...
				auto VHullShape = VM->SetClass<Compute::HullShape>("physics_hull_shape", false);
				...
				auto VRigidBodyDesc = VM->SetPod<Compute::RigidBody::Desc>("physics_rigidbody_desc");
				...
				auto VRigidBody = VM->SetClass<Compute::RigidBody>("physics_rigidbody", false);
				...
				auto VSoftBodySConvex = VM->SetStruct<Compute::SoftBody::Desc::CV::SConvex>("physics_softbody_desc_cv_sconvex");
				...
				auto VSoftBodySPatch = VM->SetPod<Compute::SoftBody::Desc::CV::SPatch>("physics_softbody_desc_cv_spatch");
				...
				auto VSoftBodySEllipsoid = VM->SetPod<Compute::SoftBody::Desc::CV::SEllipsoid>("physics_softbody_desc_cv_sellipsoid");
				...
				auto VSoftBodyCV = VM->SetPod<Compute::SoftBody::Desc::CV>("physics_softbody_desc_cv");
				...
				auto VSoftBodySConfig = VM->SetPod<Compute::SoftBody::Desc::SConfig>("physics_softbody_desc_config");
				...
				auto VSoftBodyDesc = VM->SetPod<Compute::SoftBody::Desc>("physics_softbody_desc");
				...
				auto VSoftBody = VM->SetClass<Compute::SoftBody>("physics_softbody", false);
				auto VSoftBodyRayCast = VM->SetPod<Compute::SoftBody::RayCast>("physics_softbody_raycast");
				...
				auto VConstraint = VM->SetClass<Compute::Constraint>("physics_constraint", false);
				...
				auto VPConstraintDesc = VM->SetPod<Compute::PConstraint::Desc>("physics_pconstraint_desc");
				...
				auto VPConstraint = VM->SetClass<Compute::PConstraint>("physics_pconstraint", false);
				...
				auto VHConstraintDesc = VM->SetPod<Compute::HConstraint::Desc>("physics_hconstraint_desc");
				...
				auto VHConstraint = VM->SetClass<Compute::HConstraint>("physics_hconstraint", false);
				...
				auto VSConstraintDesc = VM->SetPod<Compute::SConstraint::Desc>("physics_sconstraint_desc");
				...
				auto VSConstraint = VM->SetClass<Compute::SConstraint>("physics_sconstraint", false);
				...
				auto VCTConstraintDesc = VM->SetPod<Compute::CTConstraint::Desc>("physics_ctconstraint_desc");
				...
				auto VCTConstraint = VM->SetClass<Compute::CTConstraint>("physics_ctconstraint", false);
				...
				auto VDF6ConstraintDesc = VM->SetPod<Compute::DF6Constraint::Desc>("physics_df6constraint_desc");
				...
				auto VDF6Constraint = VM->SetClass<Compute::DF6Constraint>("physics_df6constraint", false);
				...
				auto VSimulatorDesc = VM->SetPod<Compute::Simulator::Desc>("physics_simulator_desc");
			...
			bool Registry::ImportEngine(VirtualMachine* VM)
			{
				...
				auto VApplicationSet = VM->SetEnum("application_set");
				...
				auto VPoseNode = VM->SetPod<Engine::PoseNode>("pose_node");
				...
				auto VPoseData = VM->SetPod<Engine::PoseData>("pose_data");
				...
				auto VAnimationBuffer = VM->SetPod<Engine::AnimationBuffer>("animation_buffer");
				...
				auto VRenderBufferInstance = VM->SetPod<Engine::RenderBuffer::Instance>("render_buffer_instance");
				...
				auto VRenderBuffer = VM->SetPod<Engine::RenderBuffer>("render_buffer");
				...
				auto VViewBuffer = VM->SetPod<Engine::ViewBuffer>("view_buffer");
				...
				auto VSkinModel = VM->SetClass<Engine::SkinModel>("skin_model", true);
				auto VPoseBuffer = VM->SetStructTrivial<Engine::PoseBuffer>("pose_buffer");
				...
				auto VTicker = VM->SetStructTrivial<Engine::Ticker>("clock_ticker");
				...
				auto VMaterial = VM->SetClass<Engine::Material>("material", true);
				auto VBatchData = VM->SetStructTrivial<Engine::BatchData>("batch_data");
				...
				auto VAssetCache = VM->SetStructTrivial<Engine::AssetCache>("asset_cache");
				...
				auto VAssetArchive = VM->SetStructTrivial<Engine::AssetArchive>("asset_archive");
				...
				auto VAnimatorState = VM->SetPod<Engine::AnimatorState>("animator_state");
				...
				auto VSpawnerProperties = VM->SetPod<Engine::SpawnerProperties>("spawner_properties");
				...
				auto VRenderConstants = VM->SetClass<Engine::RenderConstants>("render_constants", false);
				...
				auto VRenderSystem = VM->SetClass<Engine::RenderSystem>("render_system", true);
				auto VViewer = VM->SetStruct<Engine::Viewer>("viewer_t");
				...
				auto VAttenuation = VM->SetPod<Engine::Attenuation>("attenuation");
				...
				auto VSubsurface = VM->SetPod<Engine::Subsurface>("subsurface");
				...
				auto VSkinAnimation = VM->SetClass<Engine::SkinAnimation>("skin_animation", false);
				...
				auto VSceneGraph = VM->SetClass<Engine::SceneGraph>("scene_graph", true);
				...
				auto VComponent = VM->SetClass<Engine::Component>("base_component", false);
				auto VSparseIndex = VM->SetStructTrivial<Engine::SparseIndex>("sparse_index");
				...
				auto VModel = VM->SetClass<Engine::Model>("model", true);
				...
				auto VContentManager = VM->SetClass<Engine::ContentManager>("content_manager", true);
				auto VProcessor = VM->SetClass<Engine::Processor>("base_processor", false);
				...
				auto VDrawable = VM->SetClass<Engine::Drawable>("drawable_component", false);
				PopulateDrawableBase<Engine::Drawable>(*VDrawable);

				auto VRenderer = VM->SetClass<Engine::Renderer>("base_renderer", false);
				PopulateRendererBase<Engine::Renderer>(*VRenderer);

				auto VRsState = VM->SetPod<Engine::RenderSystem::RsState>("rs_state");
				...
				auto VSceneGraphStatistics = VM->SetPod<Engine::SceneGraph::SgStatistics>("scene_graph_statistics");
				...
				auto VApplicationCacheInfo = VM->SetStruct<Application::CacheInfo>("application_cache_info");
			...
			bool Registry::ImportComponents(VirtualMachine* VM)
			{
				...
				auto VSoftBody = VM->SetClass<Engine::Components::SoftBody>("soft_body_component", false);
				...
				auto VSliderConstraint = VM->SetClass<Engine::Components::SliderConstraint>("slider_constraint_component", false);
				...
				auto VAcceleration = VM->SetClass<Engine::Components::Acceleration>("acceleration_component", false);
				...
				auto VDecal = VM->SetClass<Engine::Components::Decal>("decal_component", false);
				...
				auto VSkinAnimator = VM->SetClass<Engine::Components::SkinAnimator>("skin_animator_component", false);
				...
				auto VKeyAnimator = VM->SetClass<Engine::Components::KeyAnimator>("key_animator_component", false);
				...
				auto VEmitterAnimator = VM->SetClass<Engine::Components::EmitterAnimator>("emitter_animator_component", false);
				...
				auto VFreeLook = VM->SetClass<Engine::Components::FreeLook>("free_look_component", false);
				...
				auto VFlyMoveInfo = VM->SetPod<Engine::Components::Fly::MoveInfo>("fly_move_info");
				...
				auto VFly = VM->SetClass<Engine::Components::Fly>("fly_component", false);
				...
				auto VAudioSource = VM->SetClass<Engine::Components::AudioSource>("audio_source_component", false);
				...
				auto VAudioListener = VM->SetClass<Engine::Components::AudioListener>("audio_listener_component", false);
				...
				auto VPointLightShadowInfo = VM->SetPod<Engine::Components::PointLight::ShadowInfo>("point_light_shadow_info");
				VPointLightShadowInfo->SetProperty<Engine::Components::PointLight::ShadowInfo>("float softness", &Engine::Components::PointLight::ShadowInfo::Softness);
				VPointLightShadowInfo->SetProperty<Engine::Components::PointLight::ShadowInfo>("float distance", &Engine::Components::PointLight::ShadowInfo::Distance);
				VPointLightShadowInfo->SetProperty<Engine::Components::PointLight::ShadowInfo>("float bias", &Engine::Components::PointLight::ShadowInfo::Bias);
				VPointLightShadowInfo->SetProperty<Engine::Components::PointLight::ShadowInfo>("uint32 iterations", &Engine::Components::PointLight::ShadowInfo::Iterations);
				VPointLightShadowInfo->SetProperty<Engine::Components::PointLight::ShadowInfo>("bool enabled", &Engine::Components::PointLight::ShadowInfo::Enabled);

				auto VPointLight = VM->SetClass<Engine::Components::PointLight>("point_light_component", false);
				...
				auto VSpotLightShadowInfo = VM->SetPod<Engine::Components::SpotLight::ShadowInfo>("spot_light_shadow_info");
				VSpotLightShadowInfo->SetProperty<Engine::Components::SpotLight::ShadowInfo>("float softness", &Engine::Components::SpotLight::ShadowInfo::Softness);
				VSpotLightShadowInfo->SetProperty<Engine::Components::SpotLight::ShadowInfo>("float distance", &Engine::Components::SpotLight::ShadowInfo::Distance);
				VSpotLightShadowInfo->SetProperty<Engine::Components::SpotLight::ShadowInfo>("float bias", &Engine::Components::SpotLight::ShadowInfo::Bias);
				VSpotLightShadowInfo->SetProperty<Engine::Components::SpotLight::ShadowInfo>("uint32 iterations", &Engine::Components::SpotLight::ShadowInfo::Iterations);
				VSpotLightShadowInfo->SetProperty<Engine::Components::SpotLight::ShadowInfo>("bool enabled", &Engine::Components::SpotLight::ShadowInfo::Enabled);

				auto VSpotLight = VM->SetClass<Engine::Components::SpotLight>("spot_light_component", false);
				...
				auto VLineLightSkyInfo = VM->SetPod<Engine::Components::LineLight::SkyInfo>("line_light_sky_info");
				VLineLightSkyInfo->SetProperty<Engine::Components::LineLight::SkyInfo>("vector3 elh_emission", &Engine::Components::LineLight::SkyInfo::RlhEmission);
				VLineLightSkyInfo->SetProperty<Engine::Components::LineLight::SkyInfo>("vector3 mie_emission", &Engine::Components::LineLight::SkyInfo::MieEmission);
				VLineLightSkyInfo->SetProperty<Engine::Components::LineLight::SkyInfo>("float rlh_height", &Engine::Components::LineLight::SkyInfo::RlhHeight);
				VLineLightSkyInfo->SetProperty<Engine::Components::LineLight::SkyInfo>("float mie_height", &Engine::Components::LineLight::SkyInfo::MieHeight);
				VLineLightSkyInfo->SetProperty<Engine::Components::LineLight::SkyInfo>("float mie_direction", &Engine::Components::LineLight::SkyInfo::MieDirection);
				VLineLightSkyInfo->SetProperty<Engine::Components::LineLight::SkyInfo>("float inner_radius", &Engine::Components::LineLight::SkyInfo::InnerRadius);
				VLineLightSkyInfo->SetProperty<Engine::Components::LineLight::SkyInfo>("float outer_radius", &Engine::Components::LineLight::SkyInfo::OuterRadius);
				VLineLightSkyInfo->SetProperty<Engine::Components::LineLight::SkyInfo>("float intensity", &Engine::Components::LineLight::SkyInfo::Intensity);

				auto VLineLightShadowInfo = VM->SetPod<Engine::Components::LineLight::ShadowInfo>("line_light_shadow_info");
				VLineLightShadowInfo->SetPropertyArray<Engine::Components::LineLight::ShadowInfo>("float distance", &Engine::Components::LineLight::ShadowInfo::Distance, 6);
				VLineLightShadowInfo->SetProperty<Engine::Components::LineLight::ShadowInfo>("float softness", &Engine::Components::LineLight::ShadowInfo::Softness);
				VLineLightShadowInfo->SetProperty<Engine::Components::LineLight::ShadowInfo>("float bias", &Engine::Components::LineLight::ShadowInfo::Bias);
				VLineLightShadowInfo->SetProperty<Engine::Components::LineLight::ShadowInfo>("float near", &Engine::Components::LineLight::ShadowInfo::Near);
				VLineLightShadowInfo->SetProperty<Engine::Components::LineLight::ShadowInfo>("float far", &Engine::Components::LineLight::ShadowInfo::Far);
				VLineLightShadowInfo->SetProperty<Engine::Components::LineLight::ShadowInfo>("uint32 iterations", &Engine::Components::LineLight::ShadowInfo::Iterations);
				VLineLightShadowInfo->SetProperty<Engine::Components::LineLight::ShadowInfo>("uint32 cascades", &Engine::Components::LineLight::ShadowInfo::Cascades);
				VLineLightShadowInfo->SetProperty<Engine::Components::LineLight::ShadowInfo>("bool enabled", &Engine::Components::LineLight::ShadowInfo::Enabled);

				auto VLineLight = VM->SetClass<Engine::Components::LineLight>("line_light_component", false);
				...
				auto VSurfaceLight = VM->SetClass<Engine::Components::SurfaceLight>("surface_light_component", false);
				...
				auto VIlluminator = VM->SetClass<Engine::Components::Illuminator>("illuminator_component", false);
				...
				auto VCamera = VM->SetClass<Engine::Components::Camera>("camera_component", false);
				...
				auto VScriptable = VM->SetClass<Engine::Components::Scriptable>("scriptable_component", false);
			...
			bool Registry::ImportRenderers(VirtualMachine* VM)
			{
				...
				auto VLightingIPointLight = VM->SetPod<Engine::Renderers::Lighting::IPointLight>("lighting_point_light");
				...
				auto VLightingISpotLight = VM->SetPod<Engine::Renderers::Lighting::ISpotLight>("lighting_spot_light");
				...
				auto VLightingILineLight = VM->SetPod<Engine::Renderers::Lighting::ILineLight>("lighting_line_light");
				...
				auto VLightingIAmbientLight = VM->SetPod<Engine::Renderers::Lighting::IAmbientLight>("lighting_ambient_light");
				...
				auto VLightingIVoxelBuffer = VM->SetPod<Engine::Renderers::Lighting::IVoxelBuffer>("lighting_voxel_buffer");
				...
				auto VLighting = VM->SetClass<Engine::Renderers::Lighting>("lighting_renderer", false);
				...
				auto VTransparencyRenderConstant = VM->SetPod<Engine::Renderers::Transparency::RenderConstant>("transparency_render_constant");
				...
				auto VTransparency = VM->SetClass<Engine::Renderers::Transparency>("transparency_renderer", false);
				...
				auto VSSRReflectanceBuffer = VM->SetPod<Engine::Renderers::SSR::ReflectanceBuffer>("ssr_reflectance_buffer");
				...
				auto VSSRGlossBuffer = VM->SetPod<Engine::Renderers::SSR::GlossBuffer>("ssr_gloss_buffer");
				...
				auto VSSR = VM->SetClass<Engine::Renderers::SSR>("ssr_renderer", false);
				...
				auto VSSGIStochasticBuffer = VM->SetPod<Engine::Renderers::SSGI::StochasticBuffer>("ssgi_stochastic_buffer");
				...
				auto VSSGIDenoiseBuffer = VM->SetPod<Engine::Renderers::SSGI::DenoiseBuffer>("ssgi_denoise_buffer");
				...
				auto VSSGI = VM->SetClass<Engine::Renderers::SSGI>("ssgi_renderer", false);
				...
				auto VSSAOShadingBuffer = VM->SetPod<Engine::Renderers::SSAO::ShadingBuffer>("ssao_shading_buffer");
				...
				auto VSSAOFiboBuffer = VM->SetPod<Engine::Renderers::SSAO::FiboBuffer>("ssao_fibo_buffer");
				...
				auto VSSAO = VM->SetClass<Engine::Renderers::SSAO>("ssao_renderer", false);
				...
				auto VDoFFocusBuffer = VM->SetPod<Engine::Renderers::DoF::FocusBuffer>("dof_focus_buffer");
				...
				auto VDoF = VM->SetClass<Engine::Renderers::DoF>("dof_renderer", false);
				...
				auto VMotionBlurVelocityBuffer = VM->SetPod<Engine::Renderers::MotionBlur::VelocityBuffer>("motion_blur_velocity_buffer");
				...
				auto VMotionBlurMotionBuffer = VM->SetPod<Engine::Renderers::MotionBlur::MotionBuffer>("motion_blur_motion_buffer");
				...
				auto VMotionBlur = VM->SetClass<Engine::Renderers::MotionBlur>("motion_blur_renderer", false);
				...
				auto VBloomExtractionBuffer = VM->SetPod<Engine::Renderers::Bloom::ExtractionBuffer>("bloom_extraction_buffer");
				...
				auto VBloomFiboBuffer = VM->SetPod<Engine::Renderers::Bloom::FiboBuffer>("bloom_fibo_buffer");
				...
				auto VBloom = VM->SetClass<Engine::Renderers::Bloom>("bloom_renderer", false);
				...
				auto VToneLuminanceBuffer = VM->SetPod<Engine::Renderers::Tone::LuminanceBuffer>("tone_luminance_buffer");
				...
				auto VToneMappingBuffer = VM->SetPod<Engine::Renderers::Tone::MappingBuffer>("tone_mapping_buffer");
				...
				auto VTone = VM->SetClass<Engine::Renderers::Tone>("tone_renderer", false);
				...
				auto VGlitchDistortionBuffer = VM->SetPod<Engine::Renderers::Glitch::DistortionBuffer>("glitch_distortion_buffer");
				...
				auto VGlitch = VM->SetClass<Engine::Renderers::Glitch>("glitch_renderer", false);
