...
#include <functional>
#include <limits>
#define VI_VS (unsigned int)Mavi::Graphics::ShaderType::Vertex
#define VI_PS (unsigned int)Mavi::Graphics::ShaderType::Pixel
#define VI_GS (unsigned int)Mavi::Graphics::ShaderType::Geometry
#define VI_CS (unsigned int)Mavi::Graphics::ShaderType::Compute
#define VI_HS (unsigned int)Mavi::Graphics::ShaderType::Hull
#define VI_DS (unsigned int)Mavi::Graphics::ShaderType::Domain
