...
namespace
{
	static DXGI_FORMAT GetNonDepthFormat(Mavi::Graphics::Format Format)
	{
		switch (Format)
		{
	...
	static DXGI_FORMAT GetBaseDepthFormat(Mavi::Graphics::Format Format)
	{
		switch (Format)
		{
	...
	static DXGI_FORMAT GetInternalDepthFormat(Mavi::Graphics::Format Format)
	{
		switch (Format)
		{
			case Mavi::Graphics::Format::R32_Float:
	...
	static DXGI_FORMAT GetDepthFormat(Mavi::Graphics::Format Format)
	{
		switch (Format)
		{
			case Mavi::Graphics::Format::R32_Float:
	...
	namespace Graphics
	{
		namespace D3D11
		{
			...
			bool D3D11Device::CubemapPush(Cubemap* Resource, TextureCube* Result)
			{
				...
				{
					VI_ERR("[d3d11] cannot create texture cube for cubemap");
					return Result;
				}
				...
				{
					VI_ERR("[d3d11] cannot create texture resource for cubemap");
					return false;
				}
			...
			bool D3D11Device::GenerateTexture(Texture3D* Resource)
			{
				...
				VI_ERR("[d3d11] could not generate texture 3d resource");
				return false;
			}
			bool D3D11Device::GenerateTexture(TextureCube* Resource)
			{
				...
				VI_ERR("[d3d11] could not generate texture cube resource");
				return false;
			}
			...
			Shader* D3D11Device::CreateShader(const Shader::Desc& I)
			{
				...
				if (!Preprocess(F))
				{
					VI_ERR("[d3d11] shader preprocessing failed");
					return Result;
				}
			...
			Cubemap* D3D11Device::CreateCubemap(const Cubemap::Desc& I)
			{
				...
				{
					VI_ERR("[d3d11] cannot create texture 2d for cubemap");
					return Result;
				}
			...
			bool D3D11Device::CreateTexture2D(Texture2D* Resource, DXGI_FORMAT InternalFormat)
			{
				...
				VI_ERR("[d3d11] could not generate texture 2d resource");
				return false;
			}
			...
			ID3D11InputLayout* D3D11Device::GenerateInputLayout(D3D11Shader* Shader)
			{
				...
				for (size_t i = 0; i < Register.Layout->Layout.size(); i++)
				{
					...
					switch (It.Format)
					{
						case Mavi::Graphics::AttributeType::Byte:
							if (It.Components == 3)
							{
								VI_ERR("[d3d11] no 24bit support format for this type");
								return nullptr;
							}
							...
							break;
						case Mavi::Graphics::AttributeType::Ubyte:
							if (It.Components == 3)
							{
								VI_ERR("[d3d11] no 24bit support format for this type");
								return nullptr;
							...
							break;
						case Mavi::Graphics::AttributeType::Half:
							if (It.Components == 1)
							...
							break;
						case Mavi::Graphics::AttributeType::Float:
							if (It.Components == 1)
								At.Format = DXGI_FORMAT_R32_FLOAT;
							else if (It.Components == 2)
							...
							break;
						case Mavi::Graphics::AttributeType::Int:
							if (It.Components == 1)
							...
							break;
						case Mavi::Graphics::AttributeType::Uint:
							if (It.Components == 1)
