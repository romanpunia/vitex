...
== WHAT IT IS ===========================
 ...
 This refs is an SDK for Herringbone Wang Tile generation:

      http://nothings.org/gamedev/herringbone

 The core design is that you use this refs offline to generate a
 "template" of the tiles you'll create. You then edit those tiles, then
 load the created tile image file back into this refs and use it at
 runtime to generate "maps".
 
 You cannot load arbitrary tile image files with this refs; it is
 ...
 You *can* use this refs to generate from arbitrary tile sets, but
...
// refs. (you allocate storage for stbhw_tileset and function fills it out;
