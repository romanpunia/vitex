...
namespace Tomahawk
{
	namespace Script
	{
		...
		bool CERegisterDateTime(VMManager* Engine)
		{
			...
			VDateTime.SetMethod("DateTime& SetDateSeconds(uint64, bool = false)", &Core::DateTime::SetDateSeconds);
			VDateTime.SetMethod("DateTime& SetDateMinutes(uint64, bool = false)", &Core::DateTime::SetDateMinutes);
			VDateTime.SetMethod("DateTime& SetDateHours(uint64, bool = false)", &Core::DateTime::SetDateHours);
			VDateTime.SetMethod("DateTime& SetDateDay(uint64, bool = false)", &Core::DateTime::SetDateDay);
			VDateTime.SetMethod("DateTime& SetDateWeek(uint64, bool = false)", &Core::DateTime::SetDateWeek);
			VDateTime.SetMethod("DateTime& SetDateMonth(uint64, bool = false)", &Core::DateTime::SetDateMonth);
			VDateTime.SetMethod("DateTime& SetDateYear(uint64, bool = false)", &Core::DateTime::SetDateYear);
