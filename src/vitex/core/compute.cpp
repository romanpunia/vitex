...
namespace
{
	...
	{
	public:
		int(*Callback)(Vitex::Compute::ShapeContact*, const Vitex::Compute::CollisionBody&, const Vitex::Compute::CollisionBody&) = nullptr;
	...
	{
	public:
		int(*Callback)(Vitex::Compute::RayContact*, const Vitex::Compute::CollisionBody&) = nullptr;
	...
	btTransform M16_TO_BT(const Vitex::Compute::Matrix4x4& In)
	{
		btMatrix3x3 Offset;
		Offset[0][0] = In.Row[0];
		Offset[1][0] = In.Row[1];
		...
		Vitex::Compute::Vector3 Position = In.Position();
