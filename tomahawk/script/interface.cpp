		...
		namespace Interface
		{
			...
			void EnableCompute(VMManager* Manager)
			{
				Manager->Namespace("Compute", [](VMGlobal* Global)
				{
					...
					VMWTypeClass VInfluenceVertex = Global->SetPod<InfluenceVertex>("InfluenceVertex");
					...
					VInfluenceVertex.SetProperty("float PositionX", &InfluenceVertex::PositionX);
					VInfluenceVertex.SetProperty("float PositionY", &InfluenceVertex::PositionY);
					VInfluenceVertex.SetProperty("float PositionZ", &InfluenceVertex::PositionZ);
					VInfluenceVertex.SetProperty("float TexCoordX", &InfluenceVertex::TexCoordX);
					VInfluenceVertex.SetProperty("float TexCoordY", &InfluenceVertex::TexCoordY);
					VInfluenceVertex.SetProperty("float NormalX", &InfluenceVertex::NormalX);
					VInfluenceVertex.SetProperty("float NormalY", &InfluenceVertex::NormalY);
					VInfluenceVertex.SetProperty("float NormalZ", &InfluenceVertex::NormalZ);
					VInfluenceVertex.SetProperty("float TangentX", &InfluenceVertex::TangentX);
					VInfluenceVertex.SetProperty("float TangentY", &InfluenceVertex::TangentY);
					VInfluenceVertex.SetProperty("float TangentZ", &InfluenceVertex::TangentZ);
					VInfluenceVertex.SetProperty("float BitangentX", &InfluenceVertex::BitangentX);
					VInfluenceVertex.SetProperty("float BitangentY", &InfluenceVertex::BitangentY);
					VInfluenceVertex.SetProperty("float BitangentZ", &InfluenceVertex::BitangentZ);
					VInfluenceVertex.SetProperty("float JointIndex0", &InfluenceVertex::JointIndex0);
					VInfluenceVertex.SetProperty("float JointIndex1", &InfluenceVertex::JointIndex1);
					VInfluenceVertex.SetProperty("float JointIndex2", &InfluenceVertex::JointIndex2);
					VInfluenceVertex.SetProperty("float JointIndex3", &InfluenceVertex::JointIndex3);
					VInfluenceVertex.SetProperty("float JointBias0", &InfluenceVertex::JointBias0);
					VInfluenceVertex.SetProperty("float JointBias1", &InfluenceVertex::JointBias1);
					VInfluenceVertex.SetProperty("float JointBias2", &InfluenceVertex::JointBias2);
					VInfluenceVertex.SetProperty("float JointBias3", &InfluenceVertex::JointBias3);
